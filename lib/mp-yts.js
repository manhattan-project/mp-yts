...
/***/ function(module, exports, __webpack_require__) {
	...
	var types = ['json', 'jsonp', 'xml'];

	var YTS = function YTS() {
	  var _this = this;

	  var options = arguments.length <= 0 || arguments[0] === undefined ? defaultOptions : arguments[0];
	  var type = arguments.length <= 1 || arguments[1] === undefined ? types[0] : arguments[1];
	      ...
	      return regeneratorRuntime.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              endpoint = _this.baseUrl + '/list_movies.' + _this.type;
	            ...
	            case 3:
	              _context.next = 5;
	              return _this.request.get(endpoint, { params: params });
	      ...
	      return regeneratorRuntime.wrap(function _callee2$(_context2) {
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            case 0:
	              endpoint = _this.baseUrl + '/movie_details.' + _this.type;
	      ...
	      return regeneratorRuntime.wrap(function _callee3$(_context3) {
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            case 0:
	              endpoint = _this.baseUrl + '/movie_reviews.' + _this.type;
	  ...
	  this.upcoming = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
	    var endpoint;
	    return regeneratorRuntime.wrap(function _callee4$(_context4) {
	      while (1) {
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            endpoint = _this.baseUrl + '/list_upcoming.' + _this.type;
	            _context4.next = 3;
	            return _this.request.get(endpoint, { params: params });
	  ...
	  this.request = _axios2.default.create(options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(311);
